...
#
# Phase 8 (tenant_routing) : les 3 ForeignKey vers settings.AUTH_USER_MODEL
# (destinataire/expediteur/responsable) ont été retirées (voir 0001_initial.py
# pour la justification). Les trois champs sont de toute façon supprimés dès
# 0011_remove_archiveinventaire_responsable_and_more.py (remplacés par
# id_destinataire/id_expediteur/id_responsable) — leur type exact ici
# n'affecte que le rejeu sur une base tenant fraîche, jamais 'default'.
