...
Endpoints exposés (Phase 1 uniquement) :
...
Autorisation : le Tenant Management est une opération de PLATFORM SCOPE.
Tous les endpoints exigent le rôle PLATFORM_ADMIN (voir permissions.py) —
le rôle métier "ADMIN", local à un établissement, n'y donne pas accès.
"""
...
from .serializers import TenantSerializer, TenantStatusUpdateSerializer
