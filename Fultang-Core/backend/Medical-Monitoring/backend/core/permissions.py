...
constant). Medical-Monitoring devient ici un troisième service exposant
...
nouveau protocole d'authentification introduit :
  ...
  - `POST /internal/sync-notify/` (voir signals.py) — pas un endpoint
    exposé par ce service, pour mémoire seulement : c'est clinical-agent
    qui exige ce même jeton en ENTRÉE, pas Medical-Monitoring.
"""
import hmac
