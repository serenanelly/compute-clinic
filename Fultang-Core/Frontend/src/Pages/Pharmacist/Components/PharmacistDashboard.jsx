...
export function PharmacistDashBoard({ children, linkList, requiredRole, requiredFunctionalService }) {
    ...
    const [activeTabPath, setActiveTabPath] = useState(() => {
        return sessionStorage.getItem('pharmacistActiveTab') || location.pathname;
    });
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            ...
            sessionStorage.setItem('pharmacistActiveTab', location.pathname);
    ...
    return (
        <div className="flex h-screen">
            ...
            <div className="flex-1 min-h-screen overflow-x-hidden ml-[17.5%] flex flex-col">
                <PharmacistNavBar />
